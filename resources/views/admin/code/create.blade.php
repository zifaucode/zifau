                    ...
                    <form @submit.prevent="sendData" enctype="multipart/form-data">
                        <div class="col-sm-12">
                            ...
                            <div class="mb-2">
                                ...
                                <input v-model="link_download" class="form-control" id="validationCustom01" type="text" placeholder="ex:https://github.com/zifaucode" required="">
                            ...
                            <div class="mb-2">
                                ...
                                <input v-model="link_demo" class="form-control" id="validationCustom01" type="text" placeholder="Link Demo" required="">
